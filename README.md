...
> Важливо для організації курсу:
> 1. Перед стартом переконайтеся, що у вашій групі ця тема ще не обрана більше 2 разів.
> 2. Після вибору теми залиште **коментар** у журналі групи в колонці “Тема фінального проєкту” з назвою теми і посиланням на **публічний репозиторій**.
...
## Git workflow (очікування викладача)

- Розробляти фічі в окремих гілках `feature/*`.
- Мержити через Pull Request.
- Робити дрібні атомарні коміти з чіткими повідомленнями.

Приклад гілок:
- `feature/profile-and-bmr`
